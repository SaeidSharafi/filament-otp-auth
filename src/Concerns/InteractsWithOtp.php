...
use Saeidsharafi\FilamentOtpAuth\AnonymouseNotifiable; // Assuming this exists, might need removal if not used
...
use SaeidSharafi\FilamentOtpAuth\Notifications\SendPasswordResetOtpEmail; // Import the new notification
...
trait InteractsWithOtp
{
    ...
    protected function getOtpModel(): string
    {
        ...
        return config('filament-otp-auth.otp_model', \SaeidSharafi\FilamentOtpAuth\Models\Otp::class);
    }
